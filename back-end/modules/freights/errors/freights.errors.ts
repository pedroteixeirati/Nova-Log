...
export const freightErrors = {
  ...
  invalidOrigin: () => new AppError('Informe uma origem valida para o frete.', { code: 'invalid_freight_origin', field: 'origin' }),
  invalidDestination: () => new AppError('Informe um destino valido para o frete.', { code: 'invalid_freight_destination', field: 'destination' }),
